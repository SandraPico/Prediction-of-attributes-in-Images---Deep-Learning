...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    names_to_values, names_to_updates = slim.metrics.aggregate_metric_map({
        ...
        'True_Positive': slim.metrics.streaming_true_positives(predictions, labels),
        'False_Positive': slim.metrics.streaming_false_positives(predictions, labels),
        'True_Negative': slim.metrics.streaming_true_negatives(predictions, labels),
        'False_Negative': slim.metrics.streaming_false_negatives(predictions, labels),
        ...
        # 'True_Positive': tf.metrics.true_positives(labels, predictions),
        # 'False_Positive': tf.metrics.false_positives(labels, predictions),
        # 'True_Negative': tf.metrics.true_negatives(labels, predictions),
        # 'False_Negative': tf.metrics.false_negatives(labels, predictions),
    ...
    #get the mislabeled filenames and save them into a file
