...
TRAIN_DIR=/cfs/klemming/nobackup/c/collery/DL/result/SMILE_CROPPED/train
EVAL_DIR=/cfs/klemming/nobackup/c/collery/DL/result/SMILE_CROPPED/eval


# Where the dataset is saved to.
DATASET_DIR=/cfs/klemming/nobackup/c/collery/DL/dataset/smile_cropped
